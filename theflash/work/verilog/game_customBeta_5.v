...
module game_customBeta_5 (
  ...
  wire [16-1:0] M_memory_player_won_output;
  ...
  game_miniRegfiles_13 memory (
    ...
    .player_won_output(M_memory_player_won_output)
  );
  ...
  always @* begin
    ...
    player_won = M_memory_player_won_output;
