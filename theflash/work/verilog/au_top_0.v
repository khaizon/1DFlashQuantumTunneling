...
module au_top_0 (
  ...
  always @* begin
    ...
    if (M_gameMachine_lives == 2'h3) begin
      livesled[0+0-:1] = 1'h1;
      livesled[1+0-:1] = 1'h1;
      livesled[2+0-:1] = 1'h1;
    end else begin
      if (M_gameMachine_lives == 2'h2) begin
        livesled[0+0-:1] = 1'h1;
        livesled[1+0-:1] = 1'h1;
        livesled[2+0-:1] = 1'h0;
      end else begin
        if (M_gameMachine_lives == 1'h1) begin
          livesled[0+0-:1] = 1'h1;
          livesled[1+0-:1] = 1'h0;
          livesled[2+0-:1] = 1'h0;
        end else begin
    ...
    if (M_gameMachine_level == 2'h3) begin
      levelled[0+0-:1] = 1'h1;
      levelled[1+0-:1] = 1'h1;
      levelled[2+0-:1] = 1'h1;
    end else begin
      if (M_gameMachine_level == 2'h2) begin
        levelled[0+0-:1] = 1'h1;
        levelled[1+0-:1] = 1'h1;
        levelled[2+0-:1] = 1'h0;
      end else begin
        if (M_gameMachine_level == 1'h1) begin
          levelled[0+0-:1] = 1'h1;
          levelled[1+0-:1] = 1'h0;
          levelled[2+0-:1] = 1'h0;
        end else begin
